  ...
  return (
    <JoinContainer>
      ...
      <form>
        ...
        <input type="text" id="id" className="id" />
        <button className="idCheck" type="button">
          중복확인
        </button>

        <label htmlFor="pw">비밀번호</label>
        <input type="password" id="pw" className="pw" />

        <label htmlFor="pwCheck">비밀번호 재확인</label>
        <input type="password" id="pwCheck" className="pw" />

        <label htmlFor="name">이름</label>
        <input type="text" id="name" className="name" />

        <label htmlFor="phoneNum">휴대폰번호</label>
        <input type="text" id="phoneNum" className="phoneNum" />
